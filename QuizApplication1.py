...
def result(user):
    ...
    print("Score\t\t\t", end="")
    print(sc[0], "\t\t", end="") if (sc[0] != None) else print("Not taken", "\t", end="")
    print(sc[1], "\t\t", end="") if (sc[1] != None) else print("Not taken", "\t", end="")
    print(sc[2], "\t\t", end="") if (sc[2] != None) else print("Not taken")
    
    print("Percentage\t\t", end="")
    print(str(sc[0]*20) + "%", "\t\t", end="") if (sc[0] != None) else print("Not taken", "\t", end="")
    print(str(sc[1]*20) + "%", "\t\t", end="") if (sc[1] != None) else print("Not taken", "\t", end="")
    print(str(sc[2]*20) + "%", "\t\t", end="") if (sc[2] != None) else print("Not taken")
    print()
    ...
    while True:
        ...
        if inp == "-1":
            ...
            while True:
                ...
                if inp in ("a", "b", "c", "-1"):
                    score[users.index(current_user)] = sc
                    break                
                else:
                    print("Invalid input!")
        elif inp == "4":
